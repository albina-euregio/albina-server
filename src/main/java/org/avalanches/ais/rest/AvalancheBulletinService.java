...
import org.avalanches.ais.controller.AvalancheBulletinController;
import org.avalanches.ais.exception.AvalancheInformationSystemException;
import org.avalanches.ais.model.AvalancheBulletin;
...
public class AvalancheBulletinService {
	...
	public Response createJSONBulletin(String bulletinString) {
		...
		JSONObject validationResult = org.avalanches.ais.json.JsonValidator.validateAvalancheBulletin(bulletinString);
	...
	public Response updateJSONBulletin(@PathParam("bulletinId") String bulletinId, String bulletinString) {
		...
		JSONObject validationResult = org.avalanches.ais.json.JsonValidator.validateSnowProfile(bulletinString);
		if (validationResult.length() == 0) {
			AvalancheBulletin bulletin = new AvalancheBulletin(bulletinJson);
