...
//@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id",scope = RegionConfiguration.class)
public class RegionConfiguration implements Serializable {
    ...
    @JoinTable(name = "socialmedia_channel_region",
