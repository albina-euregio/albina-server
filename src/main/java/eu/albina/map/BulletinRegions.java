...
public interface BulletinRegions {
	static void createBulletinRegions(List<AvalancheBulletin> bulletins, Regions regions, boolean preview) {
		final Path outputDirectory = MapUtil.getOutputDirectory(bulletins, preview);
