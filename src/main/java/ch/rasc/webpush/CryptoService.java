 ...
 * Payload Encryption
 *
 * @apiNote https://developers.google.com/web/fundamentals/push-notifications/web-push-protocol#the_payload_encryption
 */
public class CryptoService {
	...
	public byte[] encrypt(String plainTextString, SubscriptionKeys subscriptionKeys, int paddingSize) throws InvalidKeyException, NoSuchAlgorithmException, InvalidKeySpecException, InvalidAlgorithmParameterException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {
