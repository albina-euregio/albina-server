...
create table avalanche_bulletin_daytime_descriptions (ID varchar(191) not null, COMPLEXITY varchar(191), DANGER_RATING_ABOVE varchar(191), DANGER_RATING_BELOW varchar(191), ELEVATION integer, HAS_ELEVATION_DEPENDENCY bit, TERRAIN_FEATURE_ABOVE_TEXTCAT longtext, TERRAIN_FEATURE_BELOW_TEXTCAT longtext, TREELINE bit, AVALANCHE_PROBLEM_1_ID varchar(191), AVALANCHE_PROBLEM_2_ID varchar(191), AVALANCHE_PROBLEM_3_ID varchar(191), AVALANCHE_PROBLEM_4_ID varchar(191), AVALANCHE_PROBLEM_5_ID varchar(191), primary key (ID)) engine=InnoDB;
...
create table regions (ID varchar(191) not null, CREATE_CAAML_V5 bit, CREATE_CAAML_V6 bit, CREATE_JSON bit, CREATE_MAPS bit, CREATE_PDF bit, CREATE_SIMPLE_HTML bit, EMAIL_COLOR varchar(191), ENABLE_AVALANCHE_PROBLEM_CORNICES bit, ENABLE_AVALANCHE_PROBLEM_NO_DISTINCT_AVALANCHE_PROBLEM bit, ENABLE_MEDIA_FILE bit, GEO_DATA_DIRECTORY varchar(191), IMAGE_COLORBAR_BW_PATH varchar(191), IMAGE_COLORBAR_COLOR_PATH varchar(191), MAP_CENTER_LAT double precision, MAP_CENTER_LNG double precision, MAP_LOGO_BW_PATH varchar(191), MAP_LOGO_COLOR_PATH varchar(191), MAP_LOGO_POSITION varchar(191), MAP_X_MAX integer, MAP_X_MIN integer, MAP_Y_MAX integer, MAP_Y_MIN integer, MICRO_REGIONS integer, PDF_COLOR varchar(191), PDF_FOOTER_LOGO bit, PDF_FOOTER_LOGO_BW_PATH varchar(191), PDF_FOOTER_LOGO_COLOR_PATH varchar(191), PDF_MAP_HEIGHT integer, PDF_MAP_WIDTH_AM_PM integer, PDF_MAP_WIDTH_FD integer, PDF_MAP_Y_AM_PM integer, PDF_MAP_Y_FD integer, PUBLISH_BLOGS bit, PUBLISH_BULLETINS bit, SEND_EMAILS bit, SEND_PUSH_NOTIFICATIONS bit, SEND_TELEGRAM_MESSAGES bit, SHOW_MATRIX bit, SIMPLE_HTML_TEMPLATE_NAME varchar(191), SERVER_INSTANCE_ID bigint, primary key (ID)) engine=InnoDB;
create table server_instances (ID bigint not null auto_increment, API_URL varchar(191), EXTERNAL_SERVER bit, HTML_DIRECTORY varchar(191), MAP_PRODUCTION_URL varchar(191), MAPS_PATH varchar(191), MEDIA_PATH varchar(191), NAME varchar(191), PASSWORD varchar(191), PDF_DIRECTORY varchar(191), PUBLISH_AT_5PM bit, PUBLISH_AT_8PM bit, SERVER_IMAGES_URL varchar(191), USER_NAME varchar(191), primary key (ID)) engine=InnoDB;
create table subscriber_regions (SUBSCRIBER_ID varchar(191) not null, REGION_ID varchar(191) not null) engine=InnoDB;
create table subscribers (EMAIL varchar(191) not null, CONFIRMED bit, LANGUAGE varchar(191), PDF_ATTACHMENT bit, primary key (EMAIL)) engine=InnoDB;
