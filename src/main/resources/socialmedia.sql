...
create table socialmedia_shipment (id bigint not null auto_increment, CONTENT longtext, DATE datetime, ID_MP varchar(255), ID_RM varchar(255), ID_TW varchar(255), LANGUAGE varchar(255), NAME varchar(255), PROVIDER_ID bigint, REGION_ID bigint, primary key (id)) engine=InnoDB;
...
INSERT INTO ais.socialmedia_rapid_mail_config (ID, PASSWORD, USERNAME, PROVIDER_ID, REGION_CONFIGURATION_ID) VALUES(1, 'r1_pw1', 'r1_user1', 1,1);
...
INSERT INTO ais.socialmedia_messenger_people_config (ID, API_KEY, CHANNEL_NAME, MOBILE_NUMBER, PROVIDER_ID, REGION_CONFIGURATION_ID) VALUES(1, 'r1_ak1', 'r1_cn1', 'r1_mn1', 2,1);
...
INSERT INTO ais.socialmedia_rapid_mail_config (ID, PASSWORD, USERNAME, PROVIDER_ID, REGION_CONFIGURATION_ID) VALUES(2, 'r2_pw1', 'r2_user1', 1,2);
...
INSERT INTO ais.socialmedia_messenger_people_config (ID, API_KEY, CHANNEL_NAME, MOBILE_NUMBER, PROVIDER_ID, REGION_CONFIGURATION_ID) VALUES(2, 'r2_ak', 'r2_cn', 'r2_mn', 2,2);
...
INSERT INTO ais.socialmedia_rapid_mail_config (ID, PASSWORD, USERNAME, PROVIDER_ID, REGION_CONFIGURATION_ID) VALUES(3, 'r3_pw1', 'r3_user1', 1,3);
...
INSERT INTO ais.socialmedia_messenger_people_config (ID, API_KEY, CHANNEL_NAME, MOBILE_NUMBER, PROVIDER_ID, REGION_CONFIGURATION_ID) VALUES(3, 'r3_ak', 'r3_cn', 'r3_mn', 2,3);
...
INSERT INTO ais.socialmedia_rapid_mail_config (ID, PASSWORD, USERNAME, PROVIDER_ID, REGION_CONFIGURATION_ID) VALUES(4, 'r4_pw1', 'r4_user1', 1,4);
...
INSERT INTO ais.socialmedia_messenger_people_config (ID, API_KEY, CHANNEL_NAME, MOBILE_NUMBER, PROVIDER_ID, REGION_CONFIGURATION_ID) VALUES(4, 'r4_ak', 'r4_cn', 'r4_mn', 2,4);
